...
const output=path.resolve(here,'../../output2/s21-s22-soft-brand-v2.mp4');
...
try{
  ...
  await page.goto(pathToFileURL(path.join(here,'_test-v2.html')).href);
...
const picks=[65,108,167,170,174,177,180,186,299].map(f=>`eq(n\\,${f})`).join('+');
