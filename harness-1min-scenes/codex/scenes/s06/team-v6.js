 ...
 * Avatars are original vector portraits, not Minara logos or real identities. */
const researchAgents={
  rhea:{name:'Rhea',role:'Coordinator',hair:'M16 35C10 10 52 8 49 36L43 47H20Z',face:'#e2dfd7',detail:'M24 31h3m9 0h3M29 39q3 2 6 0'},
  atlas:{name:'Atlas',role:'Market research',hair:'M17 25Q18 10 35 14L46 21 43 28 35 21 20 29Z',face:'#c3c9c6',detail:'M24 31h4m8 0h4M29 40h6'},
  noor:{name:'Noor',role:'Execution research',hair:'M15 33Q7 12 26 11Q51 8 49 35L43 29 40 22 20 27Z',face:'#e4ddd0',detail:'M20 31a6 5 0 1 0 12 0a6 5 0 1 0-12 0m13 0a6 5 0 1 0 12 0a6 5 0 1 0-12 0M31 31h3M30 41h5'},
  sable:{name:'Sable',role:'Risk review',hair:'M15 33C12 5 53 10 49 37L42 27 28 22 19 36Z',face:'#bfc5ce',detail:'M23 31l5-1m7 0 5 1M29 40h6'},
};
function researchAvatar(key){const a=researchAgents[key];return `<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="32" cy="32" r="31" fill="${a.face}"/><path d="M7 64q0-18 25-18t25 18" fill="#45494c"/><path d="${a.hair}" fill="#24282a"/><ellipse cx="32" cy="32" rx="13" ry="17" fill="${a.face}"/><path d="${a.detail}" fill="none" stroke="#24282a" stroke-width="1.8" stroke-linecap="round"/><path d="M31 32v4h3" fill="none" stroke="#767a78" stroke-width="1.2"/></svg>`;}
...
research.innerHTML=`<header class="research-heading"><div class="research-members">${Object.keys(researchAgents).map(k=>researchAvatar(k)).join('')}</div><div><h2>Trading research team</h2><p>4 agents <span>·</span> Shared context</p></div></header>
...
function addResearchMotion(){
  ...
  grow('.research-members svg',6.89,.32,.07);grow('.research-heading h2',7,.3);grow('.research-heading p',7.1,.3);
  ...
  tl.to('#research-thread',{y:'-=140',duration:.5,ease:'power3.inOut'},12.42);
  tl.to('#research',{autoAlpha:0,duration:.4},12.55);
  ...
  tl.to('.client',{backgroundColor:'#0a0a0b',borderColor:'#3a3a40',boxShadow:'0 30px 80px -30px #14141666',duration:.7},13.52);
  tl.to('#chat',{backgroundColor:'#0a0a0b',duration:.65},13.56);
  tl.to('.topbar,.ticker',{autoAlpha:1,duration:.5},13.73);
}
