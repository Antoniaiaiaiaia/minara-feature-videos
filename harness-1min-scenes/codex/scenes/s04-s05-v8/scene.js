const $=s=>document.querySelector(s),DURATION=9.5,W=1920,H=1080,ORDER_START=6.5,ORDER_RATE=2;
...
$('#confirm-order').onclick=()=>{timeline.time(ORDER_START+(activeOrder+.3)/ORDER_RATE);play();};
...
function update(t){
 ...
 gsap.set('#edge',{opacity:opening||signalWall?1:0});if(t>=ORDER_START)paintOrder((t-ORDER_START)*ORDER_RATE);
