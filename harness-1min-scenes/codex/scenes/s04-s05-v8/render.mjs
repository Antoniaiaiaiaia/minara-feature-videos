...
const output=path.resolve(here,'../../output2/s04-s05-portfolio-orders-v8.mp4');
...
execFileSync('ffmpeg',['-y','-hide_banner','-loglevel','error','-i',output,'-vf',"select='eq(n,205)',scale=1600:900",'-frames:v','1',path.join(verification,'order-check.png')],{stdio:'inherit'});
