...
const output = path.resolve(here, '../../output/s12-s13-autopilot-v4.mp4');
const fps = 30;
const count = 231;
const duration = 7.7;
const checkpoints = [
  [.30, 'title-01-autopilot'], [.90, 'title-03-arriving'],
  [1.20, 'title-04-tagline'], [2.43, 'tabs'], [4.08, 'cards'],
  [4.91, 'firstprofit'], [6.29, 'firststop'], [6.65, 'secondprofit'],
  [7.66, 'ending'],
];
...
try {
  ...
  await page.goto(pathToFileURL(path.join(here, '_test-v4.html')).href, {waitUntil: 'domcontentloaded'});
