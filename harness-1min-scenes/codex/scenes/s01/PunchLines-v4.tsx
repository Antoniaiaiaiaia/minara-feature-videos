...
import {
  ...
  type SnapCnTheme,
  useSnapCnTheme,
} from "../../../remotion/src/lib/snap-cn-ui";
          ...
          return (
            <div
              ...
              style={{
                ...
                ...(beatIndex === 1 && frame >= 76 && frame <= 106
                  ? {
                      color: "transparent",
                      backgroundImage: "linear-gradient(110deg, #0a0a0b 44%, #77787e 48%, #c6c7cc 50%, #77787e 52%, #0a0a0b 56%)",
                      backgroundSize: "300% 100%",
                      backgroundPosition: `${100 * (1 - Easing.bezier(0.4, 0, 0.2, 1)((frame - 76) / 30))}% 50%`,
                      backgroundClip: "text",
                ...
                return (
                  ...
                  <Fragment key={w}>
                    ...
                    <span
                      style={{
                        display: "inline-block",
                        // A settled word needs no transform layer; keeping one
                        // prevents Chrome from clipping its parent's text fill.
