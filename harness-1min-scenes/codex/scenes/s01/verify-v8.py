...
video = scene.parents[1] / 'output2/s01-introducing-minara-harness-v8.mp4'
...
subprocess.run([
    ...
    'select=' + '+'.join(f'eq(n\\,{f})' for f in [0, 29, 30, 44, 50, 59, 60, 89, 179])
    + ',scale=533:300,tile=3x3', '-frames:v', '1', str(scene.parents[1] / 'output2/s01-verification-v8.jpg')
], check=True)
print('PASS: 180 silent 1080p/30fps frames; exactly six seconds; separate cards cut at 1s and 2s.')
